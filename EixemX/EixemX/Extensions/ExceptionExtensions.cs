...
namespace EixemX.Extensions
{
    public static class ExceptionExtensions
    {
        ...
        private static string ToFormattedDebugMessage(this Exception ex, object callingClass)
        {
        ...
        private static string ToFormattedDebugMessage(this Exception ex, Type callingClassType)
        {
